...
const (
	...
	UserV1_SendNotification_FullMethodName = "/user_v1.UserV1/SendNotification"
)
...
type UserV1Client interface {
	...
	SendNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*UserList, error)
}
...
func (c *userV1Client) SendNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*UserList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserList)
	err := c.cc.Invoke(ctx, UserV1_SendNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserV1Server interface {
	...
	SendNotification(context.Context, *Notification) (*UserList, error)
...
func (UnimplementedUserV1Server) SendNotification(context.Context, *Notification) (*UserList, error) {
...
func _UserV1_SendNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Notification)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserV1Server).SendNotification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserV1_SendNotification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).SendNotification(ctx, req.(*Notification))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserV1_SendNotification_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/service_grpc.proto",
}
